...
class SweetieFixes:
	...
	def read_cmdline_args(self):
	  ...
	  self.parser.add_argument("-p", "--pkg",  required=False, type=self.is_valid_pkg, metavar="PKG", help="robot description package name " + self.warn )
